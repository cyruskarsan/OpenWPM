...
from .base import RECORD_TYPE_CONTENT, RECORD_TYPE_CREATE, RECORD_TYPE_SPECIAL
...
def commit_unstructured_records(self):
    ...
    if self._ldb_counter >= LDB_BATCH_SIZE or (self._ldb_counter > 0 and ldb_over_time):
